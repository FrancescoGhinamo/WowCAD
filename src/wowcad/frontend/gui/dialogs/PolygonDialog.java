...
public class PolygonDialog extends JDialog implements ActionListener, CoordReceiver {

	
	private static final long serialVersionUID = -5292630527398477128L;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource().equals(btnOK)) {
			if(!txtName.getText().equals("") && !points.equals("")) {
				...
				command = CommandKeys.ADD + CadManager.COMMAND_SPLITTER + KeyWords.POLYGON + CadManager.PARAMETER_SPLITTER + txtName.getText() + points;
				dispose();
